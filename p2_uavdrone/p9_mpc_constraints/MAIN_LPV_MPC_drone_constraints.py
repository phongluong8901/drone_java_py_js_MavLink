...
statesTotal=np.array([states]) # It will keep track of all your states during the entire manoeuvre
# statesTotal2=np.array([states])
statesTotal_ani=np.array([states[6:len(states)]])
...
if constraint_switch==1:
    ''' To solve the MPC with constraints, you need qpsolvers library. You can install it with the following commands'''
    ''' Ubuntu Terminal: pip3 install qpsolvers '''
    ''' Windows 10: pip install qpsolvers; however, in Windows 10, you will need to install the Visual C++ Build Tools to build all package dependencies.'''
    ''' https://visualstudio.microsoft.com/visual-cpp-build-tools/ '''
    ''' Windows 10: pip install cvxopt'''
